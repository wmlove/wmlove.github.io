...
(function () {
    ...
    zns.site.fx.browser_test.createDOM = function () {
        ...
        oDiv.innerHTML =
            '<a href="javascript:;" title="关闭" class="browser_close" target="_blank" rel="external"></a>' +
            ...
            '</p>' +
            '<p class="browser_btn">' +
            '<a href="http://www.google.cn/chrome" class="upgrade" target="_blank"></a><a href="support_list.html" class="testing" target="_blank"></a><a href="javascript:;" class="prompt" target="_blank" rel="external"></a>' +
            '</p>';
