...
jQuery.fn.extend( {
	offset: function( options ) {
		...
		// Support: IE </div></=9></=44></=10></=9></=4.3></=9></=35></=4.0></=10></=2.3></=42></=4.1></=9></tbody></=9></=43></=9></=></=></"></)></tag></\></537.32></9,></9></8></9></option></29,></8></4.0></24></=2.3></=>